package bsu.denisenya.lab4.group7;
...
public class GraphicsDisplay extends JPanel
{
    ...
    // сюда мы передаём массивы чтобы фигура отрисовалась и количество точек из которых состоит фигура
    ...
    protected void paintMarkers(Graphics2D canvas)
    {
        ...
        for (Double[] point : graphicsData)
        {
            ...
            int Y_num = (int) Math.floor(point[1]);
            int intPart = (int)Math.sqrt(Y_num);
           //boolean isSquare = isPerfectSquare(Y_num);
           // if (intPart * intPart == Y_num)
            if(isPerfectSquare(Y_num))
            ...
            Line2D.Double verticalLine1 = new Line2D.Double();
            verticalLine1.setLine(
