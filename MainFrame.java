    ...
    public MainFrame(Double[] coefficients) {
        ...
        Action aboutAction = new AbstractAction("Автор") {
            public void actionPerformed(ActionEvent event) {
                ...
                aboutNameTF = new JLabel("Денисеня Анастасия");
                githubLinkButton = new JButton();

                githubLinkButton.setText("<HTML><FONT color=\"#000099\"><U>github.com/nastassia1840</U></FONT></HTML>");
                ...
                githubLinkButton.setToolTipText("github.com/nastassia1840");
                ...
                githubLinkButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        if (Desktop.isDesktopSupported()) {
                            try {
                                Desktop.getDesktop().browse(new URI("https://github.com/nastassia1840"));
